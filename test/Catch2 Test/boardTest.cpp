...
TEST_CASE("board infos don't change over time") {
    ...
    std::vector<Labyrinth_44422::model::Position> playersDefaultPositions = {
            Labyrinth_44422::model::Position{0, 6},
            Labyrinth_44422::model::Position{6, 6},
            Labyrinth_44422::model::Position{6, 0},
            Labyrinth_44422::model::Position{0, 0}};
