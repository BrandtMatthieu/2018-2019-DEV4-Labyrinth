...
namespace Labyrinth_44422 {
	namespace model {
		 ...
		 */
		Player::Player(const Player &player) : nickname{player.nickname}, color{player.color}, position{player.position}, objectiveCardsLeft{player.objectiveCardsLeft}, completedObjectiveCards{player.completedObjectiveCards}, _hasInsertedTile{player._hasInsertedTile}, _hasMovedPawn{player._hasMovedPawn} {
		}
